...
<head>
    ...
    <link rel="stylesheet" href="madao.css">
    <link rel="stylesheet" type="text/css" href="{{asset('/home/css/madao.css')}}">
...
<script type="text/javascript" src="{{asset('/home/js/madao.js')}}"></script>
</body>
</html>