...
<link rel="stylesheet" src="http://yeuemvv.epizy.com/css/popup.css">
...
<body onload="popup('<p>Hế lô :)))</p></br>'); on()" onunload="s()">
...
<div id="myModal" class="reveal-modal large">
    <div id="traloi">
	  <p>Hello bạn Loan xinh đẹp</br></br></p>
      <form id="f" name="f">
...
<h1>THÍCH TUI HÔNG ?</h1>
			
<h2>TẮT "TAB" NÀY ĐI LÀ CÓ :))))</h2>
...
<center>
<div id="co"> 
<a href="#" data-reveal-id="myModal">CÓ</a>
</div> 

<div id="lbNo" style="position:absolute; left: 700px; top: 300px;"> 
<input type="button" value="KHÔNG" style="cursor:pointer;" onMouseMove="move()" > 
</div>
</center> 
